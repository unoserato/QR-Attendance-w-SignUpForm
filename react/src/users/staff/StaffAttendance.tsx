  ...
  return (
    <>
      <div className={`flex flex-col h-full w-full bg-white`}>
        {/* header */}
        <div className="flex items-center w-full gap-2 p-4 g-white z-10">
        ...
        {/* wrapper ng list at view */}
        <div className="flex w-full h-full overflow-hidden">
          {/* list */}
          <div className="flex h-full w-full overflow-auto">
            <ul
              className={`gap-2 p-4 w-full grid ${
            ...
            >
              {filteredActs.map((a) => (
                <li
                  key={a.id}
                  className={`flex flex-col gap-2 rounded-xl px-2 py-4 shadow w-full border border-neutral-200 ${
                    overlayId === a.id ? "bg-neutral-200" : ""
                  }`}
                >
          ...
          {/* Overlay */}
          <div
            className={`flex p-2 h-full bg-neutral-200 rounded-xl overflow-auto transition-opacity duration-300
        ${
          isOpen
            ? "opacity-100 max-w-1/2 min-w-1/2"
            : "opacity-0 min-w-0 max-w-0 pointer-events-none"
        }`}
          >
            {/* Card */}
            <div
              className={`w-full h-fit p-4 shadow-md bg-white rounded-xl
            ...
            >
              ...
              <div className="flex flex-col gap-4 overflow-hidden h-full">
                ...
                <div className="flex-1">
                  <div className="gap-4 px-2 sm:flex w-full text-sm items-center">
      ...
      {/* mobile view */}
      <div
        className={`sm:hidden xl:hidden md:hidden block relative w-full bg-white`}
      >
        {/* Activity List */}
